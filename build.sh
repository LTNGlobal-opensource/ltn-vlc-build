...
# Build VLC itself
./bootstrap
./configure --disable-nls --enable-xcb --enable-xvideo --disable-glx --enable-alsa --disable-sdl --disable-dbus --disable-lua --disable-mad --enable-a52 --disable-libgcrypt --disable-chromaprint --disable-qt --disable-skins2  --disable-live555  --disable-libva --disable-freetype --with-decklink-sdk=`cd ../blackmagic_sdk && pwd` --prefix=/usr
make -j8
